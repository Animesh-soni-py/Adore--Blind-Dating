...
export default function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-12 lg:py-5xl relative scroll-mt-20" style={{ background: 'linear-gradient(180deg, #0F0A1E 0%, #1A1A2E 50%, #0F0A1E 100%)' }} aria-label="Features">
